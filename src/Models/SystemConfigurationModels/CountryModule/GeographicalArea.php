...
use PixelApp\Database\Factories\SystemConfigurationFactories\GeographicalGeographicalAreaFactory;
...
class GeographicalArea extends PixelBaseModel implements BelongsToCity
{
    ...
    const ROUTE_PARAMETER_NAME = "geographical_area";
    ...
    {
        return GeographicalGeographicalAreaFactory::new();
    }
}

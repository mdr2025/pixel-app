...
namespace PixelApp\Http\Requests\SystemConfigurationRequests\GeographicalAreas;
...
class UpdatingGeographicalAreaRequest extends BaseFormRequest implements NeedsModelKeyAdvancedValidation
{
    ...
    {
        return BasePolicy::check('edit', GeographicalArea::class);
    }
    ...
    {
        return [
            "name" => ["nullable", Rule::unique("geographical_areas")->ignore($data["id"], "id")],

...
class BranchPolicy extends BasePolicy
{
    ...
    {
        return $this->permissionExaminer->addPermissionToCheck("read_sc-dropdown-lists-branches")
    ...
    {
        return $this->permissionExaminer->addPermissionToCheck("create_sc-dropdown-lists-branches")
            ->hasPermissionsOrFail();
    }
    ...
    {
        return $this->permissionExaminer->addPermissionToCheck("edit_sc-dropdown-lists-branches")
            ->hasPermissionsOrFail();
    }
    /**
     * @return bool
